...
/// <summary>
/// Library for Handling Speed, angularSpeed and Direction of the animator;
/// won't change the transform of the gameobject.
/// </summary>
public class AnimatorLocomotion
{
    ...
    public AnimatorLocomotion(Animator animator)
    {
        m_Animator = animator;
